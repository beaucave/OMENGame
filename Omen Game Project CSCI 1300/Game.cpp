...
void Game::gameStart()
{
    ...
    */
    ...
    else
    {
        ...
        char magicType;
        cout << endl << "Pick your magic: Red (improves ATK), Green (improves DEF), or Blue (improves STAMINA)." << endl;
        cout << "R. Red" << endl;
        cout << "G. Green" << endl;
        cout << "B. Blue" << endl;
        ...
        while (magicType != 'R' || magicType != 'G' || magicType != 'B' || magicType != 'K')
        {
            ...
            else if (magicType == 'K')
            {
                ...
                cout << "The light seems to dim around your fingers." << endl << endl;
                break;
            }
            else
            {
...
void Game::endGame()
{
    ...
    */
    ...
    cout << endl << "You've done all you can do. It's time to go." << endl;
...
void Game::genGameSetup()
{
    ...
    */
    ...
    string attackStoreItems[] = { "weapon1", "weapon2", "weapon3", "weapon4", "weapon5",  "weapon6", };
    string defenseStoreItems[] = { "jewelry1", "jewelry2", "jewelry3", "jewelry4", "jewelry5",  "jewelry6", };
    string staminaStoreItems[] = { "gemstone1", "gemstone2", "gemstone3", "gemstone4", "gemstone5",  "gemstone6", };
    string hpStoreItems[] = { "vial1", "vial2", "vial3", "vial4", "vial5",  "vial6", };
...
void Game::genPrintTutorial()
{
    ...
    */
    ...
    cout << "Now, it's your duty to protect the rest of the world from magical dangers." << endl << endl;
    ...
    cout << "You can improve these stats with practice, special items, or by LEVELING UP!" << endl << endl;
    ...
    cout << "(3) Enter a DREAM. Dreams are home to monstrous SHADES and their minions. Fighting them is risky, but earns you experience and can come with big rewards!" << endl << endl;
...
void Game::menuDream()
{
    ...
    */
    ...
    if (myPlayer.getTutorial() == true)
    {
        ...
        cout << "Y. Walk me through this." << endl << "N. I don't need it." << endl;
        ...
        switch (dreamChoice)
        {
            ...
            case '1':
            {
                ...
                if (dream.isShadeLocation() == true) 
                {
                    ...
                    cout << myBestiary.getDesc(shadeIndex) << endl << endl;
                ...
                if (dream.isMinionLocation() == true) 
                {
                    ...
                    cout << myBestiary.getDesc(minionIndex) << endl << endl;
...
void Game::menuMarket()
{
    ...
    */
    ...
    while (marketChoice != '9')
    {
        ...
        cout << "What section do you browse?" << endl;
        ...
        switch (marketChoice)
        {
            default:
            {
                cout << "That's not possible!" << endl << endl;
                break;
            }
...
int Game::shopPurchaseItem(int storeID, int storeSlot)
{
    ...
    */
    ...
    cout << "You have " << myPlayer.getWallet() << " dollars available." << endl << endl;
...
int Game::shopSellItem(int inventorySlot)
{
    ...
    */
    ...
    cout << "You have " << myPlayer.getWallet() << " dollars." << endl << endl;
